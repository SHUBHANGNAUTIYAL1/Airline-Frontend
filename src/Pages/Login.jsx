...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/home")
      // Optionally, handle the response, such as storing the token or redirecting the user
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div className="bg-black bg-opacity-80  p-10 rounded-xl shadow-xl">
        ...
        <p className="mt-4 text-[16px] text-center text-white">New User? <a href="/register" className="text-blue-300 underline">Sign Up</a></p>
      </div>
